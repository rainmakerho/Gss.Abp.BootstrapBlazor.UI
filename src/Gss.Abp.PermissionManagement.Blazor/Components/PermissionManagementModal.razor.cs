...
namespace Gss.Abp.PermissionManagement.Blazor.Components;
public partial class PermissionManagementModal
{
    ...
    {
        return InvokeAsync(_modal.Close);
    }
    ...
    protected virtual async Task SaveAsync()
    {
        try
        {
            ...
            await InvokeAsync(_modal.Close);
    ...
    protected virtual Task ClosingModal(MouseEventArgs eventArgs)
    {

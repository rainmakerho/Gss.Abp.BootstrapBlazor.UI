...
using Gss.Abp.AspNetCore.Components.Server.BasicTheme;
...
using Gss.Abp.Identity.Blazor.Server;
using Volo.Abp.Modularity;
using Volo.Abp.Security.Claims;
using Gss.Abp.SettingManagement.Blazor.Server;
using Volo.Abp.Swashbuckle;
using Gss.Abp.TenantManagement.Blazor.Server;
...
public class BookStoreBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "38091c92-6c07-4e81-a000-c39bfcd437ee");
            });
        }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/Acme.BookStore.Blazor.styles.css", true));
                }
            );
        });
    }
